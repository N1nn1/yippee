...
public class YippeeItems {
    ...
    public static final Item DAMAGED_DISC = register("damaged_disc", new PublicMusicDiscItem(15, YippeeSoundEvents.ITEM_RECORD_SCRATCH1, new Item.Settings().maxCount(1).group(ItemGroup.MISC).rarity(Rarity.RARE)));
    public static final Item BROKEN_DISC = register("broken_disc", new PublicMusicDiscItem(15, YippeeSoundEvents.ITEM_RECORD_SCRATCH2, new Item.Settings().maxCount(1).group(ItemGroup.MISC).rarity(Rarity.RARE)));
