...
public class YippeeBlocks {
    ...
    public static final Block MYSTICAL_OAK_SAPLING = register("mystical_oak_sapling", new SaplingBlock(new MysticalSaplingGenerator(), FabricBlockSettings.copyOf(OAK_SAPLING).luminance(state -> 4)));
